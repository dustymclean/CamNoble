...
const MiniPage: React.FC = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    if (item) {
      document.title = `${item.title} | Cam Noble Ecosystem`;
    }
  }, [id, item]);
  ...
  const getExpertKnowledge = () => {
    switch(item.id) {
      ...
      case 'noble-seltzer':
        return [
          { title: "Concentrate Crafter: The Liquid Standard", desc: "Our seltzers are crafted from premium infusions, setting the definitive Liquid Standard for social mood elevation." },
  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 fade-in duration-700 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <nav aria-label="Breadcrumb" className="mb-16">
        <Link to="/" className="inline-flex items-center text-zinc-400 hover:text-zinc-900 group transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-start">
        ...
        <div className="sticky top-32">
          <header className="mb-8">
            ...
            <h1 className="text-5xl md:text-8xl font-display font-black text-zinc-900 leading-[0.9] tracking-tighter">
          ...
          <section className="mb-24">
            ...
            <div className="space-y-16">
              {expertKnowledge.map((ek, idx) => (
                <article key={idx} className="flex items-start group">
                  ...
                  <div>
                    <h4 className="font-display font-black text-zinc-900 text-2xl tracking-tight mb-3 group-hover:text-green-900 transition-colors">
                      {ek.title === "Concentrate Crafter: The Liquid Standard" ? (
                        <>Concentrate Crafter: <span className="text-transparent bg-clip-text bg-gradient-to-br from-amber-600 via-yellow-400 to-amber-700">The Liquid Standard</span></>
                      ) : ek.title}
                    </h4>
        ...
        <div className="relative pt-12 lg:pt-0">
          ...
          <div className="absolute -bottom-12 -left-4 md:-left-16 bg-zinc-900 p-14 rounded-[4rem] shadow-3xl max-w-[420px] border border-white/5 animate-in slide-in-from-left-8 duration-1000">
             ...
             <p className="text-lg font-light text-white/90 leading-relaxed italic font-serif tracking-tight">
                ...
                {item.id === 'noble-seltzer' && "Concentrate Crafter isn't just a title; it's the Liquid Standard for social mood elevation."}
